import { GFXfont, GFXglyph } from "./GfXfont";
...
const glyphs =[
    ...
    new GFXglyph(0, 2, 18, 8, 3, -17),      // 0x21 '!'
    new GFXglyph(5, 6, 6, 8, 1, -16),       // 0x22 '"'
    new GFXglyph(10, 13, 16, 13, 0, -15),   // 0x23 '#'
    new GFXglyph(36, 11, 20, 13, 1, -17),   // 0x24 '$'
    new GFXglyph(64, 20, 17, 21, 1, -16),   // 0x25 '%'
    new GFXglyph(107, 14, 17, 16, 1, -16),  // 0x26 '&'
    new GFXglyph(137, 2, 6, 5, 1, -16),     // 0x27 '''
    new GFXglyph(139, 5, 23, 8, 2, -17),    // 0x28 '('
    new GFXglyph(154, 5, 23, 8, 1, -17),    // 0x29 ')'
    new GFXglyph(169, 7, 7, 9, 1, -17),     // 0x2A '*'
    new GFXglyph(176, 10, 11, 14, 2, -10),  // 0x2B '+'
    new GFXglyph(190, 2, 6, 7, 2, -1),      // 0x2C ','
    new GFXglyph(192, 6, 2, 8, 1, -7),      // 0x2D '-'
    new GFXglyph(194, 2, 2, 6, 2, -1),      // 0x2E '.'
    new GFXglyph(195, 7, 18, 7, 0, -17),    // 0x2F '/'
    new GFXglyph(211, 11, 17, 13, 1, -16),  // 0x30 '0'
    new GFXglyph(235, 5, 17, 13, 3, -16),   // 0x31 '1'
    new GFXglyph(246, 11, 17, 13, 1, -16),  // 0x32 '2'
    new GFXglyph(270, 11, 17, 13, 1, -16),  // 0x33 '3'
    new GFXglyph(294, 11, 17, 13, 1, -16),  // 0x34 '4'
    new GFXglyph(318, 11, 17, 13, 1, -16),  // 0x35 '5'
    new GFXglyph(342, 11, 17, 13, 1, -16),  // 0x36 '6'
    new GFXglyph(366, 11, 17, 13, 1, -16),  // 0x37 '7'
    new GFXglyph(390, 11, 17, 13, 1, -16),  // 0x38 '8'
    new GFXglyph(414, 11, 17, 13, 1, -16),  // 0x39 '9'
    new GFXglyph(438, 2, 13, 6, 2, -12),    // 0x3A ':'
    new GFXglyph(442, 2, 16, 6, 2, -11),    // 0x3B ';'
    new GFXglyph(446, 12, 12, 14, 1, -11),  // 0x3C '<'
    new GFXglyph(464, 12, 6, 14, 1, -8),    // 0x3D '='
    new GFXglyph(473, 12, 12, 14, 1, -11),  // 0x3E '>'
    new GFXglyph(491, 10, 18, 13, 2, -17),  // 0x3F '?'
    new GFXglyph(514, 22, 21, 24, 1, -17),  // 0x40 '@'
    new GFXglyph(572, 16, 18, 16, 0, -17),  // 0x41 'A'
    new GFXglyph(608, 13, 18, 16, 2, -17),  // 0x42 'B'
    new GFXglyph(638, 15, 18, 17, 1, -17),  // 0x43 'C'
    new GFXglyph(672, 14, 18, 17, 2, -17),  // 0x44 'D'
    new GFXglyph(704, 12, 18, 15, 2, -17),  // 0x45 'E'
    new GFXglyph(731, 11, 18, 14, 2, -17),  // 0x46 'F'
    new GFXglyph(756, 16, 18, 18, 1, -17),  // 0x47 'G'
    new GFXglyph(792, 13, 18, 17, 2, -17),  // 0x48 'H'
    new GFXglyph(822, 2, 18, 7, 2, -17),    // 0x49 'I'
    new GFXglyph(827, 9, 18, 13, 1, -17),   // 0x4A 'J'
    new GFXglyph(848, 14, 18, 16, 2, -17),  // 0x4B 'K'
    new GFXglyph(880, 10, 18, 14, 2, -17),  // 0x4C 'L'
    new GFXglyph(903, 16, 18, 20, 2, -17),  // 0x4D 'M'
    new GFXglyph(939, 13, 18, 18, 2, -17),  // 0x4E 'N'
    new GFXglyph(969, 17, 18, 19, 1, -17),  // 0x4F 'O'
    new GFXglyph(1008, 12, 18, 16, 2, -17), // 0x50 'P'
    new GFXglyph(1035, 17, 19, 19, 1, -17), // 0x51 'Q'
    new GFXglyph(1076, 14, 18, 17, 2, -17), // 0x52 'R'
    new GFXglyph(1108, 14, 18, 16, 1, -17), // 0x53 'S'
    new GFXglyph(1140, 12, 18, 15, 1, -17), // 0x54 'T'
    new GFXglyph(1167, 13, 18, 17, 2, -17), // 0x55 'U'
    new GFXglyph(1197, 15, 18, 15, 0, -17), // 0x56 'V'
    new GFXglyph(1231, 22, 18, 22, 0, -17), // 0x57 'W'
    new GFXglyph(1281, 15, 18, 16, 0, -17), // 0x58 'X'
    new GFXglyph(1315, 16, 18, 16, 0, -17), // 0x59 'Y'
    new GFXglyph(1351, 13, 18, 15, 1, -17), // 0x5A 'Z'
    new GFXglyph(1381, 4, 23, 7, 2, -17),   // 0x5B 'new GFXglyph('
    new GFXglyph(1393, 7, 18, 7, 0, -17),   // 0x5C '\'
    new GFXglyph(1409, 4, 23, 7, 1, -17),   // 0x5D ')'
    new GFXglyph(1421, 9, 9, 11, 1, -16),   // 0x5E '^'
    new GFXglyph(1432, 15, 1, 13, -1, 4),   // 0x5F '_'
    new GFXglyph(1434, 5, 4, 6, 1, -17),    // 0x60 '`'
    new GFXglyph(1437, 12, 13, 13, 1, -12), // 0x61 'a'
    new GFXglyph(1457, 12, 18, 13, 1, -17), // 0x62 'b'
    new GFXglyph(1484, 10, 13, 12, 1, -12), // 0x63 'c'
    new GFXglyph(1501, 11, 18, 13, 1, -17), // 0x64 'd'
    new GFXglyph(1526, 11, 13, 13, 1, -12), // 0x65 'e'
    new GFXglyph(1544, 5, 18, 7, 1, -17),   // 0x66 'f'
    new GFXglyph(1556, 11, 18, 13, 1, -12), // 0x67 'g'
    new GFXglyph(1581, 10, 18, 13, 1, -17), // 0x68 'h'
    new GFXglyph(1604, 2, 18, 5, 2, -17),   // 0x69 'i'
    new GFXglyph(1609, 4, 23, 6, 0, -17),   // 0x6A 'j'
    new GFXglyph(1621, 11, 18, 12, 1, -17), // 0x6B 'k'
    new GFXglyph(1646, 2, 18, 5, 1, -17),   // 0x6C 'l'
    new GFXglyph(1651, 17, 13, 19, 1, -12), // 0x6D 'm'
    new GFXglyph(1679, 10, 13, 13, 1, -12), // 0x6E 'n'
    new GFXglyph(1696, 11, 13, 13, 1, -12), // 0x6F 'o'
    new GFXglyph(1714, 12, 17, 13, 1, -12), // 0x70 'p'
    new GFXglyph(1740, 11, 17, 13, 1, -12), // 0x71 'q'
    new GFXglyph(1764, 6, 13, 8, 1, -12),   // 0x72 'r'
    new GFXglyph(1774, 10, 13, 12, 1, -12), // 0x73 's'
    new GFXglyph(1791, 5, 16, 7, 1, -15),   // 0x74 't'
    new GFXglyph(1801, 10, 13, 13, 1, -12), // 0x75 'u'
    new GFXglyph(1818, 12, 13, 12, 0, -12), // 0x76 'v'
    new GFXglyph(1838, 17, 13, 17, 0, -12), // 0x77 'w'
    new GFXglyph(1866, 11, 13, 11, 0, -12), // 0x78 'x'
    new GFXglyph(1884, 11, 18, 11, 0, -12), // 0x79 'y'
    new GFXglyph(1909, 10, 13, 12, 1, -12), // 0x7A 'z'
    new GFXglyph(1926, 5, 23, 8, 1, -17),   // 0x7B 'new GFXglyph('
    new GFXglyph(1941, 2, 23, 6, 2, -17),   // 0x7C '|'
    new GFXglyph(1947, 5, 23, 8, 2, -17),   // 0x7D ')'
    new GFXglyph(1962, 10, 5, 12, 1, -10)]; // 0x7E '~'


export default new GFXfont(bitmap, glyphs, 0x20, 0x7E, 29);
