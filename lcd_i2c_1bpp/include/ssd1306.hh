...
namespace lcd_i2c_1bpp
{
    ...
    esp_err_t CreateI2CMasterBusHandle(gpio_num_t scl, gpio_num_t sda, i2c_master_bus_handle_t *bus_handle)
    {
    ...
    public:
        ...
        void Scroll(int textlines)
        {
            ...
            ESP_LOGD(TAG, "Scoll h=%d count=%d, step=%d, old startline=%d", this->font->line_height, count, step, startline);
            ...
            ESP_LOGD(TAG, "New startline=%d", startline);
        }
